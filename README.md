...
"myproject" is the root dirctory that contains subdirectories: FA, ns-3-dev, shared_memory and sim_results, appart from files "net_fetch_sort.cc", "net_select_stats.cc" and "run_project.py".
